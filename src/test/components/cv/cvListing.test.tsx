...
describe('CV listing component', () => {
  ...
  it('should render title with miminmal properties', function () {
    const wrap = shallow(<CVListing company ="company" role="Engineer" startDate = "12/12/2021" description= {jobDescription}  />);
  ...
  it('should render title with full properties', function () {
    const wrap = shallow(<CVListing company ="company" role="Engineer" startDate = "12/12/2021" endDate="12/12/2022" description= {jobDescription} />);
    const accordionComponent = wrap.find('Accordion');
